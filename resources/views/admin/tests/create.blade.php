...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <h1 class="text-xl font-bold text-slate-900 mt-3">Add New Lab Test</h1>
            <p class="text-sm text-slate-500 mt-0.5">Add a new test to the laboratory catalog.</p>
        </div>

        <form method="POST" action="{{ route('admin.tests.store') }}" class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                        ...
                        placeholder="e.g. Fasting Blood Sugar (Glucose)">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="reference_range" id="reference_range" value="{{ old('reference_range') }}"
