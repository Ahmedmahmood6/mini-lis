        ...
        <div class="relative z-10 flex flex-col min-h-screen">
            ...
            <header class="px-4 sm:px-6 lg:px-8 py-5">
                <div class="max-w-3xl mx-auto flex items-center justify-between">
                        ...
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/30 flex items-center justify-center shrink-0">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
                            </svg>
                        </div>
                    ...
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl shadow-xs transition-colors">
                        Staff Login
                    </a>
                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <form action="{{ route('booking.store') }}"
                            ...
                            <div>
                                ...
                                <h3 class="text-sm font-semibold text-slate-800 uppercase tracking-wider mb-4">
                                    Patient Information
                                </h3>
                            ...
                            <div class="pt-1 border-t border-slate-100">
                                ...
                                <h3 class="text-sm font-semibold text-slate-800 uppercase tracking-wider mb-4 mt-6">
                                    Appointment Details
                                </h3>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <label class="block text-sm font-medium text-slate-700">
                                            Requested Laboratory Test(s)
                                        </label>

                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-56 overflow-y-auto border border-slate-200 rounded-xl p-3">

                                            @foreach ($tests as $test)

                                                <label class="flex items-center gap-2 border border-slate-200 rounded-lg px-3 py-2 cursor-pointer hover:bg-slate-50 has-[:checked]:bg-blue-50 has-[:checked]:border-blue-300 transition-colors">
                                                    ...
                                                    <span class="text-sm text-slate-700">
                                                        {{ $test->name }} — {{ number_format($test->price, 2) }} EGP
                                                    </span>
                                        ...
                                        <p class="text-xs text-slate-500 mt-1">
                                            Not sure which tests you need? Leave blank and reception will assist you.
                                        </p>
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full px-3.5 py-2.5 text-sm bg-white text-slate-900 rounded-xl border transition-colors duration-150 outline-none focus:ring-2 {{ $errors->has('notes') ? 'border-red-300 focus:border-red-500 focus:ring-red-500/20' : 'border-slate-300 focus:border-blue-500 focus:ring-blue-500/20' }}"
                                        >{{ old('notes') }}</textarea>
